...
func TestNegotiationHeaderBytes(t *testing.T) {
	tests := []struct {
		form                          bool
		unused                        uint8
		version                       uint32
	...
	for _, tt := range tests {
		l := newnegotiationHeader(tt.form, tt.unused, tt.version, tt.destinationConnectionIDLength, tt.destinationConnectionID, tt.sourceConnectionIDLength, tt.sourceConnectionID, tt.versionSpecificData)
		b := l.Bytes()
